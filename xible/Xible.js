const XibleApi = require('./XibleApi');
...
class Xible {
    constructor(elementSelector, options) {
        ...
        const apiFactory = XibleApi(this.editor);
    ...
    initViewAndMore(element, options){
          ...
          */
          ...
          function loadTypeDefs(typeDefs) {
              Object.keys(typeDefs).forEach((id) => {
                TypeDef.register(id, typeDefs[id]);
              });
          }
        
          function loadNodes(nodes) {
            Object.keys(nodes).forEach((id) => {
                Node.register(id, nodes[id]);
              });
          }
        ...
        loadTypeDefs.call(this, options.typeDefs);
        loadNodes.call(this, options.nodes);
...
module.exports = (element, options) => {
    var xible = new Xible(element, options);
    return xible.api;
}